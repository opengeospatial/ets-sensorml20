...
public class SuiteFixtureListener implements ISuiteListener {
	...
	/**
	 * Extracts schema references from the XML resource identified by the supplied test
	 * run argument. If this is a XML instance document, the value of the standard
	...
	void processXmlReference(ISuite suite) {
		...
		try {
			...
			if (XMLUtils.isXMLSchema(xmlFile)) {
				...
				// System.out.println("XML URI was saed into SuiteAttribute: " +
				// xmlURI.toString());
			}
		}
